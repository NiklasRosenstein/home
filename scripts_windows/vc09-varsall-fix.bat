...
:arm
if not exist "%~dp0bin\vcvarsarm.bat" goto missing
call "%~dp0bin\vcvarsarm.bat"
goto :SetVisualStudioVersion
...
:x86_arm
if not exist "%~dp0bin\vcvarsx86_arm.bat" goto missing
call "%~dp0bin\vcvarsx86_arm.bat"
goto :SetVisualStudioVersion
